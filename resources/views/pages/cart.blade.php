                    ...
                    <div class="grid grid-cols-3 items-start gap-4">
                        <div class="col-span-2 flex items-start gap-4">
                            <div class="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                <img src="{{ asset('storage/' . $c->product->image) }}" class="w-full h-full object-fill" />
                            </div>

                            <div class="flex flex-col">
                                <h3 class="text-base font-bold text-gray-800">{{ $c->product->product_name }}</h3>
                                <p class="text-xs font-semibold text-gray-500 mt-0.5">Kategori: {{ $c->product->category }} </p>
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg max-sm:text-base font-bold text-gray-800">Rp.{{ $c->product->price}}</h4>
                ...
                <div class="bg-gray-100 rounded-md p-4 h-max">
                    ...
                    <form method="POST" action="{{ route('checkout') }}" class="mt-6">
                            ...
                            <div class="space-y-3">
                                <div class="relative flex items-center">
                                    <input type="text" placeholder="Full Name"
                                        class="px-4 py-2.5 bg-white text-gray-800 rounded-md w-full text-sm border-b focus:border-gray-800 outline-none" name="name" />
                                ...
                                <div class="relative flex items-center">
                                    <input type="text" placeholder="Phone"
                                        class="px-4 py-2.5 bg-white text-gray-800 rounded-md w-full text-sm border-b focus:border-gray-800 outline-none" name="phone"/>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-4 h-4 absolute right-4"
                                ...
                                <div class="relative flex items-center">
                                    <input type="text" placeholder="Address"
                                        class="px-4 py-2.5 bg-white text-gray-800 rounded-md w-full text-sm border-b focus:border-gray-800 outline-none" name="address" />
                        ...
                        <ul class="text-gray-800 mt-6 space-y-3">
                            <li class="flex flex-wrap gap-4 text-sm">Subtotal <span class="ml-auto font-bold">Rp. {{ number_format( $cart->base_total_price ) }}</span></li>
                            ...
                            <hr class="border-gray-300" />
                            <li class="flex flex-wrap gap-4 text-sm font-bold">Total <span class="ml-auto">Rp. {{ number_format( $cart->grand_total ) }}</span></li>
                        </ul>
